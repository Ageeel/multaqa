...
class ForumApp:
    ...
    def show_dialog(self, dialog: ft.AlertDialog):
        """عرض نافذة الحوار باستخدام مدير الحوارات الرسمي في Flet."""
        try:
            self.page.show_dialog(dialog)
        except Exception as ex:
            print(f"[show_dialog] خطأ: {ex}")
            # لا نترك التطبيق معطلاً إذا كان الحوار قد أضيف/فتح مسبقاً.
            try:
                dialog.open = True
                self.safe_update()
            except Exception:
    ...
    def close_dialog(self):
        """إغلاق آخر AlertDialog مفتوح عبر مدير الحوارات الرسمي في Flet."""
        try:
            self.page.pop_dialog()
        except Exception as ex:
            print(f"[close_dialog] خطأ: {ex}")
            # fallback للإصدارات التي لا تدعم pop_dialog أو عند اختلاف الحالة.
            try:
                self.safe_update()
            except Exception:
                pass
...
def main(page: ft.Page):
    ...
    # Flet يستخدم assets/icon.png تلقائياً كأيقونة للتطبيق عند البناء.
