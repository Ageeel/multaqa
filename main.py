...
class ForumApp:
    ...
    def build_ui(self):
        ...
        self._drawer_root_container = ft.Container(
            ...
            # SafeArea يحسب تلقائياً مساحة شريط الحالة العلوي وشريط/مقبض التنقل السفلي
            # في أندرويد ويحجزها كـ padding داخلي، فيصبح الارتفاع الفعلي المتاح للعمود
            # = drawer_height ناقص هذه الحواف بدقة (بدل افتراض أن page.height بالكامل
            # مساحة مرئية قابلة للاستخدام). top=False كي يبقى رأس القائمة (التدرّج
            # اللوني) ممتداً تحت شريط الحالة كما هو التصميم الحالي، وbottom=True فقط
            # لحجز مساحة زر "بلازما" قبل شريط التنقل السفلي، وهو سبب دفعه خارج
            # المساحة المرئية للـ ListView الداخلي واضطرار المستخدم للتمرير لرؤيته.
            content=ft.SafeArea(
                top=False,
                bottom=True,
                expand=True,
