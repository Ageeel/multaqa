...
class ForumApp:
    ...
    def update_upcoming_banner(self):
        ...
        if not upcoming_list:
            ...
            member_name = next_lec.get("member_name", "غير مححدد")
    ...
    def load_lectures(self):
        def render_lectures_list(data):
            ...
            # جلب تعليقات المحاضرات من الكاش لحساب العدد الفعلي بدقة
            ...
            for item in data:
                ...
                # حساب وإسناد عدد التعليقات الحقيقي لكل محاضرة
                lec_id = item.get("id")
                actual_comments_count = len([c for c in all_lecture_comments if str(c.get("lecture_id")) == str(lec_id)])
                item["comments_count"] = actual_comments_count
